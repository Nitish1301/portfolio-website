    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                <a href="#" className="text-3xl md:text-4xl font-bold font-montserrat tracking-tight text-white">
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <a
                            key={link.name}
                            href={link.href}
                            className="text-base md:text-lg font-medium text-gray-300 hover:text-electric-blue transition-colors relative group"
                        >
                            {link.name}
