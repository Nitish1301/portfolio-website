...
const About = () => {
    return (
        <section id="about" className="relative min-h-screen flex flex-col items-center justify-center bg-[#111] py-20 overflow-hidden transition-colors duration-300">
            <ParticleBackground />
            ...
            <div className="z-10 w-full max-w-6xl px-4">
                ...
                <motion.div
                    ...
                    className="bg-[#1e1e1e]/95 backdrop-blur-sm rounded-lg shadow-2xl overflow-hidden border border-gray-800 font-mono transition-colors duration-300"
                >
                    {/* Editor Header / Tab Bar */}
                    <div className="bg-[#252526] flex items-center border-b border-gray-800 transition-colors duration-300">
                        {/* Tab */}
                        <div className="px-4 py-2 bg-[#1e1e1e] border-r border-gray-800 flex items-center gap-2 text-sm text-gray-300 border-t-2 border-t-cyan-400 transition-colors duration-300">
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-1/3 bg-[#252526] p-6 border-r border-gray-800 transition-colors duration-300">
                            {/* Image/Avatar */}
                            <div className="relative group mb-6">
                                ...
                                <div className="relative rounded-lg overflow-hidden border border-gray-800 bg-[#1e1e1e] w-64 mx-auto">
                                    <img
                                        src={profileImg}
                                        alt="Profile"
                            ...
                            {/* JSON Stats */}
                            <div className="text-sm md:text-base font-mono leading-relaxed overflow-x-auto bg-[#1e1e1e] p-4 rounded border border-gray-800 transition-colors duration-300">
                        ...
                        <div className="w-full md:w-2/3 p-6 md:p-10 bg-[#1e1e1e] text-gray-300 transition-colors duration-300">
                            <div className="prose prose-invert max-w-none font-mono">
                                <div className="mb-8">
                                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 flex items-center gap-2">
                                ...
                                <div className="mb-8">
                                    ...
                                    <ul className="list-disc list-inside text-gray-300 space-y-3 marker:text-cyan-400 text-lg md:text-xl">
                                        <li>
